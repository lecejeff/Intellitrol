...
void ADC_init (void)
{
    ...
    ADC_struct.battery_voltage = 0; // Clear state machine variables
    ADC_struct.motor_1_current = 0; //
    ADC_struct.motor_2_current = 0; //
    ADC_struct.analog_input = 0;    //
    ...
    ADC_avg.average_length = ADC_AVERAGE_LENGTH;
